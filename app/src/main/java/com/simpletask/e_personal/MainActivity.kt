...
class MainActivity : AppCompatActivity() {
    ...
    private fun grupamentoUm() {
        ...
        when (grupamentoUmValor) {
            "Peito" -> treinoPeito()
            "Costas" -> treinoCostas()
            "Quadríceps" -> treinoQuadriceps()
            "Posterior" -> treinoPosterior()
            else -> textTreinoGerado.text = mensagemNaoEncontrado
    ...
    private fun grupamentoDois() {
        ...
        val grupamentoDoisValor = grupamentoUm.selectedItem.toString()
        val mensagemNaoEncontrado = "Valor não encontrado"

        when (grupamentoDoisValor) {
            "Glúteo" -> treinoGluteo()
            "Ombros" -> treinoOmbro()
            "Tríceps" -> treinoTriceps()
            "Bíceps" -> treinoBiceps()
            else -> textTreinoGerado.text = mensagemNaoEncontrado
        }
    ...
    private fun treinoPeito() {
            ...
            handler.postDelayed({
                ...
                when (objetivoValor) {
                    ...
                    "Emagrecimento" -> {
                        // Obtenha o ArrayList de exercícios de Definição
    ...
    private fun treinoCostas() {
        ...
        handler.postDelayed({
            ...
            when (objetivoValor) {
                "Hipertrofia" -> {// Obtenha o ArrayList de exercícios de hipertrofia
        ...
        handler.postDelayed({
            ...
            when (objetivoValor) {
                ...
                "Emagrecimento" -> {
                    ...
                    // Pegue os primeiros 5 exercícios da lista (aleatórios)
                    val exerciciosAleatorios =
                        TreinoQuadriceps.treinoQuadricepsEmagrecimento().take(5)
